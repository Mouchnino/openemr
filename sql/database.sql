...
CREATE TABLE `x12_partners` (
  ...
  `x12_isa01` VARCHAR( 2 ) NOT NULL DEFAULT '00',
  `x12_isa02` VARCHAR( 10 ) NOT NULL DEFAULT '          ',
  `x12_isa03` VARCHAR( 2 ) NOT NULL DEFAULT '00',
  `x12_isa04` VARCHAR( 10 ) NOT NULL DEFAULT '          ',
