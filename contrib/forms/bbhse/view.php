...
<option value="No Abnormality" <?php if ($_obj['thought_content'] == 'No Abnormality') { echo'selected="selected"'; } ?>>No Abnormality</option>
<option value="Tangental" <?php if ($_obj['thought_content'] == 'Tangental') { echo'selected="selected"'; } ?>>Tangental</option>
<option value="Perserverative/Obsessive" <?php if ($_obj['thought_content'] == 'Perserverative/Obsessive') { echo'selected="selected"'; } ?>>Perserverative/Obsessive</option>
<option value="Delusions/Hallucinations" <?php if ($_obj['thought_content'] == 'Delusions/Hallucinations') { echo'selected="selected"'; } ?>>Delusions/Hallucinations</option>
</select>
</b>
</td>
<td>
...
<option value="Below Average" <?php if ($_obj['intellectual_ability'] == 'Below Average') { echo'selected="selected"'; } ?>>Below Average</option>
<option value="Average" <?php if ($_obj['intellectual_ability'] == 'Average') { echo'selected="selected"'; } ?>>Average</option>
<option value="Above Average"<?php if ($_obj['intellectual_ability'] == 'Above Average') { echo'selected="selected"'; } ?>>Above Average</option>
</select>
</b>
</td></tr>
...
<option value="Alert" <?php if ($_obj['attention_concentration'] == 'Alert') { echo'selected="selected"'; } ?>>Alert</option>
<option value="Oriented" <?php if ($_obj['attention_concentration'] == 'Oriented') { echo'selected="selected"'; } ?>>Oriented</option>
<option value="Inattentive/Distracted"<?php if ($_obj['attention_concentration'] == 'Inattentive/Distracted') { echo'selected="selected"'; } ?>>Inattentive/Distracted</option>
</select>
</b>
</td>
<td>
...
<option value="Adequate Detail"  <?php if ($_obj['recall'] == 'Adequate Detail') { echo'selected="selected"'; } ?>>Adequate Detail</option>
<option value="Sparse Detail" <?php if ($_obj['recall'] == 'Sparse Detail') { echo'selected="selected"'; } ?>>Sparse Detail</option>
<option value="Resisted/Avoided Topics" <?php if ($_obj['recall'] == 'Resisted/Avoided Topics') { echo'selected="selected"'; } ?>>Resisted/Avoided Topics</option>
</select>
</b>
</td></tr>
<tr>
...
<option value="No Noted Memory Impairment"  <?php if ($_obj['memory'] == 'No Noted Memory Impairment') { echo'selected="selected"'; } ?>>No Impairment Noted</option>
<option value="Short-Term Impairment" <?php if ($_obj['memory'] == 'Short-Term Impairment') { echo'selected="selected"'; } ?>>Short Term Impairment</option>
<option value="Long Term Impairment" <?php if ($_obj['memory'] == 'Long Term Impairment') { echo'selected="selected"'; } ?>>Long Term Impairment</option>
</select>
</b>
</td></tr>
...
<option value="Good"  <?php if ($_obj['insight'] == 'Good') { echo'selected="selected"'; } ?>>Good</option>
<option value="Fair" <?php if ($_obj['insight'] == 'Fair') { echo'selected="selected"'; } ?>>Fair</option>
<option value="Poor" <?php if ($_obj['insight'] == 'Poor') { echo'selected="selected"'; } ?>>Poor</option>
</select>
</b>
</td>
<td>
...
<option value="Good"  <?php if ($_obj['judgment'] == 'Good') { echo'selected="selected"'; } ?>>Good</option>
<option value="Fair" <?php if ($_obj['judgment'] == 'Fair') { echo'selected="selected"'; } ?>>Fair</option>
<option value="Poor" <?php if ($_obj['judgment'] == 'Poor') { echo'selected="selected"'; } ?>>Poor</option>
</select>
</b>
</td></tr>
<tr><td>
...
<option value="Good"  <?php if ($_obj['impulse_control'] == 'Good') { echo'selected="selected"'; } ?>>Good</option>
<option value="Fair" <?php if ($_obj['impulse_control'] == 'Fair') { echo'selected="selected"'; } ?>>Fair</option>
<option value="Poor" <?php if ($_obj['impulse_control'] == 'Poor') { echo'selected="selected"'; } ?>>Poor</option>
</select>
</b>
</td></tr>
<table>
...
<option value="No Noted or Observed Risk"<?php if ($_obj['risk_assessment'] == 'No Noted or Observed Risk') { echo'selected="selected"'; } ?>>None Noted</option>
<option value="Low Risk"<?php if ($_obj['risk_assessment'] == 'Low Risk') { echo'selected="selected"'; } ?>>Low Risk</option>
<option value="Moderate Risk"<?php if ($_obj['risk_assessment'] == 'Moderate Risk') { echo'selected="selected"'; } ?>>Moderate Risk</option>
<option value="High Risk"<?php if ($_obj['risk_assessment'] == 'High Risk') { echo'selected="selected"'; } ?>>High Risk</option>
<option value="Very High Risk"<?php if ($_obj['risk_assessment'] == 'Very High Risk') { echo'selected="selected"'; } ?>>Very High Risk</option>
</select>
</p>
